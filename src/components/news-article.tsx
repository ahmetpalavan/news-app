...
const NewsArticle = ({ source, author, title, description, url, urlToImage, publishedAt }: NewsArticleProps) => {
  ...
  return (
    <Card className='max-w-full transition-transform duration-300 transform drop-shadow-md sm:max-w-md lg:max-w-lg mx-auto my-6 shadow-md overflow-hidden flex flex-col'>
